            ...
            <div class="row g-lg-4 gy-5 justify-content-center mb-70">
                <div class="col-lg-8">
                    <div class="blog-details-wrap mb-120">
                        <div class="post-thum">
                            <img class="img-fluid" src="assets/images/blog/blog-dt-img.png" alt="blog-dt-img">
                            <div class="category">
                        ...
                        <h2 class="post-title">Luctus justo quis feugiat lacus orcha ornare auguelon Integer gon form
                            together nicelon.</h2>
                        <div class="post-content">
                            <p>Pellentesque maximus augue orci, quis congue purus iaculison id. Maecenas eu lorem quisesdoi
                                ...
                                dictumst. Nuncet posuere scelerisque justo in accumsan.Pellentesque maximus augue orci, quis
                                congue purus iaculison id. Maecenas eu lorem quisesdoi massal molestie vulputate in sitagi
                                amet diam. Cras eu odio sit amet ipsum cursus for that gone pellentesquea. thisaton
                                Vestibulum ut aliquet risus. In hac habitasse plateajoa dictumst. Nuncet posuere scelerisque
                                justo in accumsan.</p>
                            <blockquote>
                                <p><sup><img src="assets/images/icon/quage-icon-top.svg" alt="image"></sup> Integer quis
                                    ...
                                    lacinianti ultricies, est urna cursus purus, ut tristique purusenali pretium, quam ut
                                    laciniaun est urna <sub><img src="assets/images/icon/quage-icon-btm.svg"
                                            alt="image"></sub></p>
                                <cite>
                                    Ezekiel Miles
                                </cite>
                            ...
                            <p>Pellentesque maximus augue orci, quis congue purus iaculison id. Maecenas eu lorem quisesdoi
                                ...
                                dictumst. Nuncet posuere scelerisque justo in accumsan.Pellentesque maximus augue orci, quis
                                congue purus iaculison id. Maecenas eu lorem quisesdoi massal molestie vulputate in sitagi
                                amet diam. Cras eu odio sit amet ipsum</p>
                            <div class="row g-4 align-items-center mb-10 pt-10">
                                <div class="col-lg-6">
                                    ...
                                    <p>Pellentesque maximus augue orci, quis congue purus iaculison id. Maecenas eu lorem
                                        ...
                                        cursus for thata gone pellentesquea. thisaton Vestibulum ut aliquet risus. Inagi hac
                                        habitasse plateajoa dictumst. Nuncet posuere scelerisque justo in
                                        accumsan.Pellentesque maximus augue orci, quisento congue purus iaculison id.
                                        Maecenas eu lorem quisesdoi ameti</p>
                                </div>
                                <div class="col-lg-6">
                                    <img class="img-fluid" src="assets/images/blog/blog-dt-img2.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="comment-area">
                        <div class="blog-comments mb-120">
                            ...
                            <ul class="comment-list">
                                <li>
                                    <div
                                        class="single-comment mb-50 d-flex align-items-center justify-content-between flex-md-nowrap flex-wrap">
                                        ...
                                        <div class="comment-content">
                                            <div class="c-header d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="replay-btn">
                                                    <a href="#"><img src="assets/images/icon/replay-icon.svg"
                                                            alt=""> Reply</a>
                                                </div>

                                            </div>
                                            <div class="c-body">
                                                <p>Pellentesque maximus augue orci, quis congue purus iaculison id. Maecenas
                                                    eu lorem quisesdoi massal molestie vulputate in sitagi amet diam. Cras
                                                    eu odio sit amet ipsum cursus for that gone pellentesquea. thisaton
                                                    Vestibulum ut aliquet risus. In hac habitasse plateajoa dictumst. Nuncet
                                                    posuere scelerisque justo in accumsan.Pellentesque</p>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="comment-reply">
                                        <li>
                                            <div
                                                class="single-comment d-flex align-items-center justify-content-between flex-md-nowrap flex-wrap">
                                                <div class="comment-content">
                                                    <div class="c-header d-flex align-items-center justify-content-between">
                                                        <div class="author-area">
                                                            <div class="author-img">
                                                                <img src="assets/images/blog/blog-author1.png"
                                                                    alt="">
                                                            </div>
                                                            <div class="author-details">
                        ...
                        <div class="single-widgets widget_egns_recent_post mb-30">
                            ...
                            <div class="recent-post-wraper">
                                <div class="widget-cnt mb-25">
                                    <div class="wi">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-sidebar-1.png"
                                                alt="image"></a>
                                    </div>
                                    <div class="wc">
                                        <a href="blog-grid.html">July 18, 2022</a>
                                        <h6><a href="blog-details.html">Quisque laoreet Maecento facilisis tristique.</a>
                                        </h6>
                                    </div>
                                </div>
                                <div class="widget-cnt mb-25">
                                    <div class="wi">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-sidebar-2.png"
                                                alt="image"></a>
                                    </div>
                                    <div class="wc">
                                ...
                                <div class="widget-cnt">
                                    <div class="wi">
                                        <a href="blog-details.html"><img src="assets/images/blog/blog-sidebar-3.png"
                                                alt="image"></a>
                                    </div>
                                    <div class="wc">
                                        <a href="blog-grid.html">July 14, 2022</a>
                                        <h6><a href="blog-details.html">Nunc finibus gravidato on porta. Nulla vitae.</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
