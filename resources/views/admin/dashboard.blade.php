            ...
            <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="card-body">
                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                <li>
                                    <a href="#">
                                        <img alt="User Avatar" class="contacts-list-img"
                                            src="{{ asset('assets/admin/dist/img/user1-128x128.jpg') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-footer clearfix">
                        <button class="btn btn-primary float-right" type="button"><i class="fas fa-plus"></i> Add
                            item</button>
                    </div>
                </div>
                <!-- /.card -->
            ...
            <section class="col-lg-5 connectedSortable">
                ...
                <div class="card bg-gradient-primary">
                    <div class="card-header border-0">
                        ...
                        <div class="card-tools">
                            ...
                            <button class="btn btn-primary btn-sm" data-card-widget="collapse" title="Collapse"
                                type="button">
                                <i class="fas fa-minus"></i>
                            </button>
                        </div>
                ...
                <div class="card bg-gradient-info">
                    ...
                    <div class="card-footer bg-transparent">
                        <div class="row">
                            <div class="col-4 text-center">
                                <input class="knob" data-fgColor="#39CCCC" data-height="60" data-readonly="true"
                                    data-width="60" type="text" value="20">
                            ...
                            <div class="col-4 text-center">
                                <input class="knob" data-fgColor="#39CCCC" data-height="60" data-readonly="true"
                                    data-width="60" type="text" value="50">
                            ...
                            <div class="col-4 text-center">
                                <input class="knob" data-fgColor="#39CCCC" data-height="60" data-readonly="true"
                                    data-width="60" type="text" value="30">
                ...
                <div class="card bg-gradient-success">
                    <div class="card-header border-0">
                        ...
                        <div class="card-tools">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-success btn-sm dropdown-toggle" data-offset="-52"
